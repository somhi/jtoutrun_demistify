...
.rd0_addr ( rd0_addr ),
    .rd0_data    ( rd0_data ),.rd1_addr ( rd1_addr ),
    .rd1_data    ( rd1_data ),
    // PROM writting
...
jtframe_bram_rom #(.AW(15-1),.DW(16),.OFFSET(RD0_OFFSET)) u_brom_rd0(
    .clk    ( clk       ),
    // Read port
    .addr   ( rd0_addr ),
    .data   ( rd0_data ),
...
jtframe_bram_rom #(.AW(15-1),.DW(16),.OFFSET(RD1_OFFSET)) u_brom_rd1(
    .clk    ( clk       ),
    // Read port
    .addr   ( rd1_addr ),
    .data   ( rd1_data ),
